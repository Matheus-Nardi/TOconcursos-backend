...
class HistoricoService:
    ...
    def create_historico(self, historico: HistoricoRequestDTO) -> dict:
        ...
        return HistoricoResponseDTO.model_validate(db_historico).model_dump(mode="json")

    def get_historico(self, historico_id: int) -> dict | None:
    ...
    def get_all_historicos(self, skip: int, limit: int) -> list[dict]:
        ...
        return [HistoricoResponseDTO.model_validate(h).model_dump(mode="json") for h in historicos]

    def update_historico(self, historico_id: int, historico: HistoricoRequestDTO) -> dict | None:
