...
class ResolucaoQuestaoService:
    ...
    def get_resolucao(self, resolucao_id: int) -> ResolucaoQuestaoResponseDTO | None:
    ...
    def update_resolucao(self, resolucao_id: int, resolucao: ResolucaoQuestaoRequestDTO) -> ResolucaoQuestaoResponseDTO | None:
